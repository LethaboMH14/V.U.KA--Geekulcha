# CHECKLIST — the four-layer plan (archived 23 Sep 2026)

Moved from `docs/CHECKLIST.md` when VUKA pivoted to VIGIL + ANCHOR (ADR-0034). Rows are kept exactly as they stood. Live rows continue in P3: P2.12/P2.13 → P3.B8, P2.14 → P3.B9, OS.11 → P3.K7, B1 → P3.Q1, SC.1/SC.2 → P3.A5/P3.S4/P3.U2, SC.4 → P3.L6.
