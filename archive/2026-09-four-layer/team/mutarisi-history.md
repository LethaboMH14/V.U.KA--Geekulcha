# Mutarisi Chibaya — history (four-layer plan, to 23 Sep 2026)

Moved out of `team/mutarisi.md` when VUKA pivoted to VIGIL + ANCHOR (ADR-0034). Nothing here was deleted; the running log stays in the live file.
