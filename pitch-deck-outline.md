...
1. **The Hook (15s):** Emotional opening that frames express kidnapping and forced transfers in SA. Make the judge feel the urgency.
2. **The Problem (30s):** The specific pain point. Human language, not corporate jargon.
3. **The Solution (45s):** Introduce VUKA. What it is, how it works in one sentence, what makes it different.
