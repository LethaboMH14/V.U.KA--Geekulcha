...
- 2026-09-14 — Prepared `docs/FALLBACK-HOTFIX.md` for WBS 7.2. It defines the fallback order, scoped hotfix review/security requirements, prohibited bypasses and rehearsal acceptance. It remains a procedure, not evidence of a completed rehearsal.
