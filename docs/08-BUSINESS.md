...
| **2** | **~33,600 lines shipped before this hackathon existed** | 440 tests, 27 ADRs, 6,800 lines of architecture docs, measured 318 ms p95 — all committed in July, all public, all timestamped. Nobody compresses that into a weekend |
