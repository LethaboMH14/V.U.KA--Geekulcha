...
| **2** | **~33,600 lines shipped before this hackathon existed** | 440 tests, 25 ADRs, 6,800 lines of architecture docs, measured 318 ms p95 (n = 10) — all committed in July, all public, all timestamped. Nobody compresses that into a weekend |
