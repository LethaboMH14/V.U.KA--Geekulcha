...
| **G16** | The astra-audit-alignment branch introduces a third gate calendar (`docs/audit/05-team-operating-system.md`'s WBS) that does not exactly match `docs/HANDOVER.md` §6 — e.g. the clean-intake evidence item is dated Sep 14 there against G0's Sep 16 here | Sibusiso, Lethabo | Before G0 closes (16 Sep) | Open — **needs both leads' reconciliation, not a unilateral rewrite of either calendar** |
