...
~33,600 lines, 510 test-function definitions found in predecessor source (executed-suite count pending), 25 ported accepted architecture decision records, ~6,800
