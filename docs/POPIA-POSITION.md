...
- **Authored:** 16 Sep 2026 — Ipeleng (via Cline assistant), for `docs/CHECKLIST.md` `P2.2`. Co-located with the PSiRA paper on PR #28 (`docs/ipeleng-psira-position`) so both regulatory papers review together. Reviewed by: pending Lethabo, then both leads.