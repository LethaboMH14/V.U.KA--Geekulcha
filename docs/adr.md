...
**Status:** Proposed (2026-09-25, ninth draft after eight adversarial review rounds). Proposed by Lethabo (co-lead, acting security lead). Direction chosen by Lethabo on 24 Sep: **the verifiable record is available off the phone only**. Binds when Sibusiso (second lead) accepts it, after Ipeleng's security review.
