...
Added by Lethabo's Claude Code assistant from four source-checked research passes on 23 Sep (market data, fraud/legal/platform, design, and an independent red-team). Each row carries its quote source. **A Codex assistant, acting at Khutso's request, re-opened or attempted every source for the P3.K1 audit and recorded the row-level result in `docs/build-log/entries/2026-09-23-codex-khutso-p3-k1-evidence-audit.md`; Khutso's personal confirmation remains pending.** ⚑ = secondary source only, primary source unavailable, or a primary read still owed.
...
| Smartphone excise | From **1 Apr 2025**, the 9% ad valorem duty applies only to smartphones priced **greater than R2,500**; the entry-level sales **+80% in 11 months** figure remains secondary and needs its original GSMA release | [National Treasury Budget Review 2025](https://www.treasury.gov.za/documents/National%20Budget/2025Mar/review/FullBR.pdf) p.45; GSMA via The Citizen, 6 Jul 2026 | `FACT` (duty); ⚑ (sales figure) |
| UK APP-fraud reimbursement | Mandatory from 7 Oct 2024, capped at £85,000; the 50/50 split is not re-established in this audit; "gross negligence" is a high bar | psr.org.uk | `FACT`; ⚑ (split not independently re-established) |
