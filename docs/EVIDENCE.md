...
| OpenTimestamps | Calendar servers accept timestamp requests; the checked calendar server reported an average interval of **1.01 hours** during this audit. Receipt latency and Bitcoin attestation time are environment-dependent and are not claimed as fixed figures | [OpenTimestamps](https://opentimestamps.org/); [calendar server status](https://alice.btc.calendar.opentimestamps.org/) | `FACT` (service); timings not a product measurement |
| NIST FIPS 204 (ML-DSA) effective 13 Aug 2024; ML-DSA-65 public key 1,952 bytes and signature 3,309 bytes | [NIST FIPS 204 final](https://csrc.nist.gov/pubs/fips/204/final), [primary PDF table](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf) | `FACT` |
