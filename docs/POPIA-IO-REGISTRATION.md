...
- **Authored:** 16 Sep 2026 — Ipeleng (via Cline assistant), for `docs/CHECKLIST.md` `P2.5`. Co-located on PR #28 (`docs/ipeleng-psira-position`) with the two position papers it depends on. Reviewed by: pending Lethabo, then both leads.