...
Active WBS 4.2 claim (2026-09-19, **PROPOSED**): Vukosi is preparing a candidate KHAYA BOM and a repeatable mains-input power-measurement procedure. BOM economics is shared with Babatunde. Supplier webpage prices are recorded only as dated public listing observations; no formal supplier quotation, procurement choice, component compatibility approval, physical appliance, meter availability, wattage measurement, or runtime measurement is asserted. No interfaces or production contracts change.
