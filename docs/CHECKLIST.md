...
| P2.5 | **Register the Information Officer** — free, online, under 30 minutes. No excuse before any pilot | Ipeleng | C3 | Sep 17 | ◐ | Path prepared 16 Sep — `docs/POPIA-IO-REGISTRATION.md` (PR #28): eServices Portal verified as the live primary route, `Registration.IO@inforegulator.org.za` manual form as fallback, s55 duties and the five leads' inputs recorded; submission still pending (head designation D-IO-1 + org legal identity) — §7 deliberately empty |
