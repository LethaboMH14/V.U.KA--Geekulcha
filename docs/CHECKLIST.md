...
| P3.K1 | Personal re-check of every 23 Sep evidence row | Khutso | all | Sep 24 12:00 | ☑ | Khutso confirmed on 25 Sep that he checked every row and endorsed the recorded dispositions; row-by-row log: `docs/build-log/entries/2026-09-25-codex-khutso-evidence-acceptance-reconciliation.md`. PR #47 merged after Sibusiso's final-head approval. ⚑ claims remain flagged; completion is of the audit, not verification of every underlying claim. |
| P3.K2 | SAPS FY2024/25 and FY2025/26 totals read by eye | Khutso | B | Sep 24 | ☐ | Khutso's visual confirmation and Sibusiso's approval are on PR #54, which merged into the already-merged #47 branch rather than `main`. Totals restored in a new current-main PR; keep open until that correction is reviewed and merged. |
