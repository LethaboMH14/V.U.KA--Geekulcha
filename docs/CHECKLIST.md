...
| P2.3 | **Discard-by-default embeddings** — architecture, not configuration. Any embedding that does not match an enrolled, consenting resident is discarded | Sibusiso | C2 | Sep 18 | ☐ | Added 14 Sep, Lethabo |
| P2.4 | **s57(1)(a) prior authorisation** question — linking unique identifiers across responsible parties for a new purpose needs the Regulator's *prior* authorisation. A bigger gate than IO registration | Ipeleng, Sibusiso | C3 | Sep 17 | ☐ | Added 14 Sep, Lethabo |
