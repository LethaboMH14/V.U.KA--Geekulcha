...
for(const p of ['BRIEF.md','RULES.md','AGENTS.md','SECURITY.md','BUILD-LOG.md','team/TEMPLATE.md','templates/BUSINESS-HANDOFF.md','docs/OVERLAPS.md','.github/pull_request_template.md']) read(p);
